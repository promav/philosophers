...
/*   Updated: 2024/09/17 15:54:04 by pabromer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_phi	*fill_philosophers(char **argv, pthread_mutex_t *forks, \
	...
	*phil->is_dead = 0;
	...
	while (i < atoi(argv[1]))
	{
		if (argv[5])
			...
			philosopher_action_infinite, &phil[i]);
		i++;
	}
	i = 0;
	while (i < atoi(argv[1]))
